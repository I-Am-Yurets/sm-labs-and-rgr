...
/**
 * Варіант 19 – Моделювання роботи супермаркету (РГР-5).
 * Додано StatisticsManager для відображення гістограм статистики.
 */
public class Main extends JFrame {
    ...
    private void loadHtmlTask() {
        ...
        if (url != null) {
            ...
            catch (IOException e) { System.err.println("Problems with file " + str); }
        }
    }
